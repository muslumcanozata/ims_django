...
from .views import current_user, personellerRFDetailsListCreateAPIView, personellerQRDetailsListCreateAPIView, personellerListCreateAPIView, userList
...
urlpatterns = [
    ...
    path('personellerRF/<int:rfid2>/', api_views.personellerRFDetailsListCreateAPIView.as_view(), name="Personel Detay Bilgileri"),
