...
from ims.FACE_DETECT.deepface2.basemodels import VGGFace, OpenFace, Facenet, FbDeepFace, DeepID, DlibWrapper, ArcFace, Boosting
from ims.FACE_DETECT.deepface2.extendedmodels import Age, Gender, Race, Emotion
...
def stream(db_path = '', model_name ='VGG-Face', distance_metric = 'cosine', enable_face_analysis = True, source = 0, time_threshold = 5, frame_threshold = 5):
    ...
    result = realtime.analysis(db_path, model_name, distance_metric, enable_face_analysis
